        ...
        <>
            <Combobox value={selected} onChange={onSelected} multiple>
                <div className="relative mt-1">
                    ...
                    text-left shadow-md focus:outline-none focus-visible:right-2
                    focus-visible:ring-white/75 focus-visible:ring-offset-2
                    focus-visible:ring-offset-teal-300 sm:text-sm">
                        <ComboboxInput
                            className="border-gray-300 dark:border-gray-700 dark:bg-gray-950
                        ...
                        />
                        <ComboboxButton className="absolute inset-y-0 right-0 flex
                        items-center pr-2">
                            <ChevronUpDownIcon
                    ...
                    <Transition
                        ...
                        afterLeave={() => setQuery("")}
                    >
                        <ComboboxOptions className="absolute mt-1 max-h-60 w-full
                                                ...
                                                {selected ? (
                                                    <span
                                                        className={`absolute inset-y-0 left-0
                                                            flex items-center pl-3 text-white`}
                                                    >
                                                        <CheckIcon
                                                            className="h-5 w-5"
                                                            aria-hidden="true"
